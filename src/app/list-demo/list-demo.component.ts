...
export class ListDemoComponent implements OnInit {
  ...
  sqlistDataSource: ListOperateDataSource;
  linklistDatabase = new ListOperateDatabase();
  linklistDataSource: ListOperateDataSource;
  displayedColumns = ['ID', 'Name', 'Detail'];
  sqlistObject = new SequenceList<number>();
  sqlistIsInit = false;
  sqlistID = 0;
  SeqListNumberToAdd: number = -1;
  SeqListPositionToInsert: number = -1;
  SeqListNumberToInsert: number = -1;
  linklistObject = new LinkList<number>();
  linklistIsInit = false;
  linklistID = 0;
  LinkListNumberToAdd: number = -1;
  LinkListPositionToInsert: number = -1;
  LinkListNumberToInsert: number = -1;
